...
# -*- coding: utf-8 -*-
#
# ipymicro_base documentation build configuration file
#
...
_version_py = os.path.join(repo, 'ipymicro_base', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'ipymicro_basedoc'
...
latex_documents = [
    (master_doc, 'ipymicro_base.tex', 'ipymicro_base Documentation',
     'Ian Hunt-Isaak', 'manual'),
]
